 ...
 * @author Dell
 */
public class FIzmeniDobavljaca extends javax.swing.JDialog {

    Dobavljac d;

    /**
     * Creates new form FIzmeniDobavljaca
     */
    public FIzmeniDobavljaca(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    }
    
    FIzmeniDobavljaca(FRadSaDobavljacima aThis, boolean b, Dobavljac d) {
        initComponents();
        this.d = d;
        popuniCB();
        srediFormu();
    ...
    private void initComponents() {
        ...
        jbtnIzmeniDobavljaca = new javax.swing.JButton();
        ...
        jbtnIzmeniDobavljaca.setText("Izmeni dobavljaca");
        jbtnIzmeniDobavljaca.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jbtnIzmeniDobavljacaActionPerformed(evt);
            }
        });
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(44, 44, 44))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(jbtnIzmeniDobavljaca, javax.swing.GroupLayout.PREFERRED_SIZE, 198, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(0, 0, Short.MAX_VALUE))))
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jbtnIzmeniDobavljaca)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void jbtnIzmeniDobavljacaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnIzmeniDobavljacaActionPerformed
        ...
        Dobavljac dobavljac = new Dobavljac(dobid, nazivDob, pib, telefon, fax, mail, tekuciRacun, delatnost, mesto, ulica, adresa, null, brojRacuna);
         if(!brojRacuna.equals(d.getBrojRacuna())){
        
            dodatak=", brojRacuna='"+dobavljac.getBrojRacuna()+"'";
        
        }
        Kontroler.getInstanca().izmeniDobavljaca(dobavljac,dodatak);

    }//GEN-LAST:event_jbtnIzmeniDobavljacaActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FIzmeniDobavljaca.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FIzmeniDobavljaca dialog = new FIzmeniDobavljaca(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JButton jbtnIzmeniDobavljaca;
    ...
    private void srediFormu() {
        ...
        jtxtIDDobavljaca.setText(d.getDobavljacID() + "");
        jtxtNazivDob.setText(d.getNazivDobavljaca());
        jtxtPib.setText(d.getPib());
        jtxtTelefon.setText(d.getTelefon());
        jtxtFax1.setText(d.getFax());
        jtxtMail.setText(d.getMail());
        jtxtBrojRacuna.setText(d.getBrojRacuna());
        jcmbDelatnost.setSelectedItem(d.getDelatnost());
        jcmbTekuciRacun.setSelectedItem(d.getTekuciRacun());
        jcmbMesto.setSelectedItem(d.getMesto());
        jcmbUlica.setSelectedItem(d.getUlica());
        jcmbAdresa.setSelectedItem(d.getAdresa());
