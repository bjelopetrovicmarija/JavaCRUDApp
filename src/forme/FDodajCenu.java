 ...
 * @author Dell
 */
public class FDodajCenu extends javax.swing.JDialog {

    /**
     * Creates new form FDodajCenu
     */
    public FDodajCenu(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        popuniCBValuta();
    }
    ...
    private void jbtnDodajActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnDodajActionPerformed
        ...
        FKreirajArtikal fka=(FKreirajArtikal) getParent();
        fka.dodajCenu(cena);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FDodajCenu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FDodajCenu dialog = new FDodajCenu(new javax.swing.JFrame(), true);
